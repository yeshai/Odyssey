...
(***********************************************************)
#FLUX_HEIGHT= -68 + #PART_THICKNESS	(LEAD TO JUST TOUCH FLUX)
...
#SOLDER_HEIGHT= -72 + #PART_THICKNESS (@PUMP = 550 RPM)
#ANGLE_OVER_WAVE= 0
...
M98 PPREHEAT2		(MOVE TO PREHEAT POSITION AND PREHEAT
ENDIF

M98 PPUMPSTART                 (START SOLDER PUMP)
M98 PSOLDERDIP2		 	(MOVE TOOL HEAD TO SOLDER POT POSITION AND DIP)
