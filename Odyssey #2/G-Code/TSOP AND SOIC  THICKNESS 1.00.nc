( Part thickness 1.2000* TYPICAL SETTINGS ***********************)
( ********************** AUTOFLUX = True  ***********************)
( ********************** IR PREHEAT = True  *********************)
( ********************** PREHEAT TIME [s] = 60 ******************)
( ********************** SOLDER SPEED [mm/min] = 575 **************)
( ********************** SOLDER PUMP [RPM] = 550 ****************)
(***********************************************************)
...
(***********************************************************)
#FLUX_HEIGHT= -75.0+ #PART_THICKNESS	(LEAD TO JUST TOUCH FLUX)
...
#SOLDER_HEIGHT= -67.0 + #PART_THICKNESS (@PUMP = 550 RPM)
#ANGLE_OVER_WAVE= 0
(***********************************************************)
