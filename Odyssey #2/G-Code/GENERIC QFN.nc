...
(***********************************************************)
#PALLETWIDTH= -145 + #PART_THICKNESS (NEGATIVE PALLET WIDTH TO SUBTRACT FROM X - GO ACROSS WAVE BACKWARDS)
#SOLDER_HEIGHT= -120
#ANGLE_OVER_WAVE= -40 (NEGATIVE ANGLE ACCOUNTS FOR TRAVEL DIRECTION)
#SOLDER_POSITION= 1209 - #PALLETWIDTH (MINUS PALLET WIDTH SINCE PALLET WIDTH IS NEGATIVE)
(***********************************************************)
