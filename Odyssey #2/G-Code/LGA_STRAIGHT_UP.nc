( THICKNESS*********0.22 TYPICAL SETTINGS ***********************)
( ********************** AUTOFLUX = False ***********************)
( ********************** IR PREHEAT = False *********************)
( ********************** PREHEAT TIME [s] = 30 ******************)
( ********************** SOLDER SPEED [mm/s] = 550 **************)
( ********************** SOLDER PUMP [RPM] = 550 ****************)
(***********************************************************)
...
#SOLDER_HEIGHT= -109 (-110.5 MAX FOR ANGLE = 0 !!!)
#ANGLE_OVER_WAVE= 14
#SOLDER_POSITION= 1230.75 + #PALLETWIDTH (1232.5 ALMOST TOUCHES @ A =0)
...
G01 X-#PH_DISTANCE F#SPEED_ACROSS_WAVE
G01 X-7 Z39.5 F#SPEED_ACROSS_WAVE
G01 Z23 F#SPEED_ACROSS_WAVE (MOVE UP)
G90 (ABSOLUTE MODE)
G01 A92 F50000(FLIP)
G04 P10
G01 Z-10 F10000
