...
OSOLDERDIP
G01 A0 F1080
G01 X#SOLDER_POSITION_ Z-5 F20000
G01 A#ANGLE_OVER_WAVE_ F1080                (ROTATE HEAD TO PROCESS ANGLE)
G01 Z#SOLDER_HEIGHT_ F4000      (MOVE TO Z HEIGHT FOR PROCESS)
G04 P0.5          (TIME
...
(***********************************************************)
OANGLECALCOPERATOR_
#ANGHYP= #PALLETWIDTH/COS[#ANGLE_OVER_WAVE_]
#VERTCHANGE= #ANGHYP*SIN[#ANGLE_OVER_WAVE_]
G91
G01 X#PALLETWIDTH Z#VERTCHANGE F#SPEED_ACROSS_WAVE_
G90
M99
(***********************************************************)
