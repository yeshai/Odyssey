...
#FLUX_HEIGHT= -94.3 		            (SET SO PINS/PADS TOUCH FLUX-SURFACE)
#FLUX_DWELL= 0.5
#FLUX_DRIP_DWELL= 2
#FLUX_DRIP_ANGLE= 35
...
#SOLDER_HEIGHT = -79.75 +1.50            (LEAD-FREE SOLDER POT NOZZLE HEIGHT, Z-POSITION)
#SPEED_OVER_WAVE= 500        (SPEED ACROSS LEAD-FREE SOLDER WAVE)
