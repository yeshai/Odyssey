...
#FLUX_X = 689.74 (FLUX X @ A=60)
#FLUX_Z = -91.76 (FLUX Z @ A=60)
...
G04 P3.0            (WAIT 2.0 SECOND)
(G01 B5   F600	  (SPIN +5 DEGREES, B=5)
G01 Z5 f1000         (BACK OUT OF WAVE, WAS 100)
