...
#FLUX_X = 868 (FLUX X @ A=0)
#FLUX_Z = -45.4 (FLUX Z @ A=0)

G01 X#FLUX_X   F20000   (MOVE TO FLUX)
G01 Z#FLUX_Z           (DIP IN FLUX)
G04 P1.5             (ENSURE DIP BEFORE SPIN)
G90                 (SWITCH TO ABSOLUTE COORDINATES)
G01 Z0 (MOVE UP)
G01 X694.5
G01 A60 (TILT)
...
#SOLDER_X = 1968 (SOLDER X @ A=0)
#SOLDER_Z = -32 	(SOLDER Z @ A=0)

G01 X#SOLDER_X F20000    (MOVE TO PB-FREE POT)
G01 Z#SOLDER_Z            (MOVE DOWN TOWARDS WAVE)
G91                 (SWITCH TO RELAVTIVE COORDINATES)

G01 X74  F600      (DIP ACRSS SOLDER)
...
#RINSE_X = 441.3(RINSE_X @ A=0)
#RINSE_Z = -44.6(RINSE_Z @ A=0)
...
G01 X165  F20000    (MOVE TO BASKET)
G04 P0.5            (WAIT 0.5 SECONDS)
