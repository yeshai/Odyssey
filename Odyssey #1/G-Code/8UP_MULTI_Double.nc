...
#FLUX_X = 693 (FLUX X @ A=60)
#FLUX_Z = -86.5 (FLUX Z @ A=60)
...
#SOLDER_X = 1864.9(SOLDER X @ A=45)
#SOLDER_Z = -34.6	(SOLDER Z @ A=45)
...
G04 P0.5            (WAIT 0.5 SECONDS)
G01 Z[#ZTOUCH + 3.5] F500       (PUT PARTS DOWN)
M33                 (TURN VACUUM OFF)
...
G04 P0.5            (WAIT 0.5 SECONDS)
M43                 (OPEN TO ATMOSPHERE)
G01 Z[#ZTOUCH + 5.5] F500       (MOVE UP)
G04 P3.5            (WAIT 3.5 SECONDS)
M25                 (TURN OFF AIR KNIFE)
G04 P1.0            (WAIT 1.0 SECOND)
M24                 (TURN ON AIR KNIFE)
G01 Z[#ZTOUCH + 7.5] F500       (MOVE UP)
