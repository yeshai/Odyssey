...
#FLUX_X2 = 691.6 (FLUX, DIP WIDE SIDE X @ A=60)
#FLUX_Z2 = -93.8 (FLUX, DIP WIDE SIDE Z @ A=60)
...
#SOLDER_X2 = 1561.99 (SOLDER X @ A=45)
#SOLDER_Z2 = -17.77  (SOLDER Z @ A=45)
...
G04 P1.5            (WAIT 2.0 SECONDS)
G01 B6   F400	  (SPIN +5 DEGREES, B=5)
G01 Z5 B4 F200         (BACK OUT OF WAVE)
...
G04 P1.5           (WAIT 2.0 SECONDS)
G01 B6    F400	  (SPIN +5 DEGREES, B=275)
G01 Z5 B4 F200         (BACK OUT OF WAVE)
G01 Z7 F20000       (BACK OUT OF WAVE)
...
#RINSE_X2 = 228.03  (RINSE_X @ A=60)
#RINSE_Z2 = -92.9   (RINSE_Z @ A=60)
