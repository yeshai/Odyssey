...
#FLUX_X = #XSTART + 649.05 (FLUX X @ A=60)
#FLUX_Z = #ZTOUCH - 32.5 (FLUX Z @ A=60)
...
#SOLDER_X = #XSTART + 1522.49 (SOLDER X @ A=45)
#SOLDER_Z = #ZTOUCH + 41.79 (SOLDER Z @ A=45)
