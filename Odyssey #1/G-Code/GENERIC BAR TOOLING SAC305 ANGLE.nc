...
#FLUX_HEIGHT= -95.0 		            (SET SO PINS/PADS TOUCH FLUX-SURFACE)
#FLUX_DWELL= 0.5
#FLUX_DRIP_DWELL= 2
#FLUX_DRIP_ANGLE= 35
...
#SOLDER_HEIGHT = -85.0 +2            (LEAD-FREE SOLDER POT NOZZLE HEIGHT, Z-POSITION)
#SPEED_OVER_WAVE=800        (SPEED ACROSS LEAD-FREE SOLDER WAVE)
#SOLDER_POSITION = 1917         (BAR EDGE ~= WAVE START)
#ANGLE_OVER_WAVE = 6             (LEAD-FREE SOLDER POT X-POSITION)
