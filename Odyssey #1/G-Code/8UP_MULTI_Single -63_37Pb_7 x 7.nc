...
#FLUX_X = 688.87 (FLUX X @ A=60)
#FLUX_Z = -89.75(FLUX Z @ A=60,83)
...
#SOLDER_X = 1563.90 (SOLDER X @ A=45)
#SOLDER_Z = -18.05(SOLDER Z @ A=45)
...
#RINSE_X = 230.37 (RINSE_X @ A=60)
#RINSE_Z = -89.25  (RINSE_X @ A=60)
...
G01 Z[#ZTOUCH +1.25] F500       (MOVE UP)
