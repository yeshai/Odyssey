...
OLEADFLAT
G01 X1025 Z-5 F20000 			(MOVE TO DIP STATION)
G01 X1030 Z-43 F2000 			(MOVE TO WIPE START)
M20								(DROSS WIPER DOWN)
G04 P3					
G01 X1190 Z-43 F2000				(WIPE DROSS LEFT TO RIGHT)
G04 P2	
G01 X1190 Z-30 F2000				(MOVE UP)
(G01 X1191 Z-30 F2000				(MOVE RIGHT)
(G01 X1191 Z-43 F2000				(MOVE BACK DOWN)
G04 P1
M21 							(DROSS WIPER UP)
G04 P2
(G01 X1020 Z-30 F2000 			(MOVE RIGHT TO LEFT)
(G04 P1

G01 X1245 Z-43 				(CENTER TOOL OVER NOZZLE)
G01 Z#SOLDER_HEIGHT F4000
G01 Z#SOLDER_HEIGHT-#SOLDER_DIP_DEPTH F#SOLDER_DIP_SPEED_IN
G04 P#SOLDER_DWELL
G01 Z#SOLDER_HEIGHT F#SOLDER_DIP_SPEED_OUT
G01 Z-5 F4000
M17 M35					 (TURN OFF PUMP1 AND NITROGEN1)
M99
...
G01 A0 F1080
G01 X#SOLDER_POSITION Z-5 F20000
G01 A-25 F4000		 	(ROTATE TO ANGLE)
G01 Z#SOLDER_HEIGHT F4000		 	(MOVE TO Z HEIGHT FOR PROCESS)
G91 (SWITCH TO RELAVTIVE COORDINATES)
G01 X55  F#SPEED_ACROSS_WAVE
G04 P0.5 (WAIT AFTER DIP)
G90 (SWITCH TO ABSOLUTE COORDINATES)
G01 Z-5 F4000 				 	(RETURN TO PROCESS POSITION
G01 A0 F1080
M17 M35					 	(TURN OFF PUMP1 AND NITROGEN1)
...
G91
G01 X#PALLETWIDTH Z#VERTCHANGE F#SPEED_OVER_WAVE
G90
M99
